...
<button type="submit" class="btn btn-primary button-roxo" name="cadastrar">Registrar Compra</button>
</form>
...
if (isset($_POST['cadastrar'])) {
  ...
  move_uploaded_file($foto["tmp_name"], $caminho_imagem);
        ...
        $sql = mysql_query("INSERT INTO compras (nome,valor,notas,data,img)
          VALUES ('$nome','$valor','$notas','$data','$nome_imagem')");
